...
if ($response1['video']['status'] != 'ready') {
	...
	echo "<xmp>" .  json_encode(array('conversion' => '', 'html'=>"<p>Your video has been uploaded. Conversion details will appear shortly.</p>", 'video_key' => $vars['video_key'], 'response' => array($response1, $response2))) . "</xmp>";
