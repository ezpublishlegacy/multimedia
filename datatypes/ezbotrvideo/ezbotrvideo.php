    ...
    */
    function eZBotrVideo( $id )
    {
		...
		if ($response1['video']['status'] != 'ready') {
			...
			$this->Attributes = array('conversion' => '', 'html'=>"<p>You're video has been uploaded. Conversion details will appear shortly.</p>", 'video_key' => $id, 'response' => array($response1, $response2), 'download' => '/content/error/404');
